                            ...
                            <div class="main-menu-two__main-menu-box">
                                ...
                                <ul class="main-menu__list one-page-scroll-menu">
                                    <li class="scrollToLink">
                                        <a style="font-weight: 1.5rem" href="#banner">Home </a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a style="font-weight: 1.5rem" href="#about">About</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a style="font-weight: 1.5rem" href="#why-us">Why Us</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a style="font-weight: 1.5rem" href="#products">Products</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a style="font-weight: 1.5rem" href="#contact">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="services-two__single">
                                ...
                                <h3 class="services-two__title"><a href="#">HIWARE</a></h3>
                                ...
                                <a href="#" style="margin-top: 1rem" class="thm-btn about-two__btn">Discover
                                    More</a>
                            </div>
                        </div>
